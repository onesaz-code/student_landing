...
export default function App() {
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen relative overflow-hidden dark:bg-[#0F172A] light:bg-white transition-colors duration-500">{/* Changed from light:bg-[#F8FAFC] to light:bg-white */}
