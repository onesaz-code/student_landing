          ...
          <div className="inline-flex dark:bg-[#1E293B] light:bg-white rounded-xl p-1.5 gap-2 border dark:border-[#334155] light:border-[#E2E8F0] light:shadow-md">
            {tabs.map((tab) => (
              <button
                ...
                className={`px-6 py-3.5 rounded-lg text-sm font-semibold transition-all duration-300 active:scale-95 ${
                  activeTab === tab.id
            ...
            {currentFeatures.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative dark:bg-[#1E293B] light:bg-white rounded-xl p-6 border dark:border-[#334155] light:border-[#E2E8F0] light:shadow-md hover:shadow-xl dark:hover:shadow-[#818CF8]/10 light:hover:shadow-lg transition-all duration-300 overflow-hidden ${
